#
#  Be sure to run `pod spec lint ZZLDRefresh.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "ZZLDRefresh"
  s.version      = "0.0.1"
  s.summary      = "仿微博 | 知乎回答 | 京东 | 途牛旅游 高扩展性"
  ...
  s.author             = { "pengzz" => "email@address.com" }
  # Or just: s.author    = "pengzz"
  # s.authors            = { "pengzz" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/pengzz"
  ...
  s.ios.deployment_target = "7.0"      # s.ios.deployment_target = "5.0"
  ...
  # s.resource  = "icon.png"
  s.resources = "LDRefresh/**/*.png", "Assets.xcassets"

  # s.preserve_paths = "FilesToSave", "MoreFilesToSave"
  s.preserve_paths = "FilesToSave", "Assets.xcassets"
